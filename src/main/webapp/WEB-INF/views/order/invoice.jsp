                    ...
                    <div class="x_content">
                        <section class="content invoice">
                                    ...
                                    <div class="col-xs-12 table">
                                        <table class="table table-striped">
                                            ...
                                            <c:forEach items="${sortedExamList}" var="orderExam">
                                                <tr>
                                                    <td class="col-xs-6">${orderExam.exam.name}
                                                        - ${orderExam.exam.code}</td>
                                                    <c:if test="${orderForm.period eq 'June'}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <p class="text-muted well well-sm no-shadow" style="margin-top: 10px;">
                                        NERIC no longer charges by scanned exams. NERIC moved to a pay one price model
                                        based on RWADA (student counts for non-public schools) for testing services.
                                        This will simplify the billing process for both BOCES and districts and you will
                                        now have exact testing charges ahead of time for budget planning rather than
                                        having to wait much later in the year to be billed for number of tests scanned.
                                        <strong>This model will include all scanning and non-secure documents charges
                                            for the Regents Exams.</strong>
                                        If you are a public school district, this will be implemented immediately on the
                                        commitment forms that are sent to districts. Non-public schools will be billed
                                        in the fall of the current school year for testing services.
                                        Non-public schools will be billed in the fall of 2018 for the 2018-2019 testing
                                        charge. Questions about this billing model can be directed to <a
                                            href="mailto:testing@neric.org">testing@neric.org</a>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="row no-print">
                                <div class="col-xs-12">
                                    <button class="btn btn-default pull-right" onclick="window.print();"><i

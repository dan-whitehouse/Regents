							...
							<form:form method="POST" modelAttribute="setting" class="form-horizontal form-label-left">								
								...
								<div class="item form-group">
									...
									<div class="col-md-3 col-sm-3 col-xs-6" has-feedback>
										<form:input type="text" path="name" id="name" class="form-control col-md-7 col-xs-12 has-feedback-left" name="name" placeholder="Key" required="required"/>
										<form:input type="text" path="value" id="value" class="form-control col-md-7 col-xs-12 has-feedback-left" name="name" placeholder="Value" required="required"/>

                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                        <a href="${createOrderFormLink}">Create OrderForm</a>
                    ...
                    <div class="x_content">
                        ...
                        <div class="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-control col-md-7 col-xs-12 active">
                                        <fmt:formatNumber value="${orderForm.rescanFee}" type="number"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-control col-md-7 col-xs-12 active">
                                        <fmt:formatNumber value="${orderForm.inDistrictScanFee}" type="number"
                                                          maxFractionDigits="2" minFractionDigits="2"
                                                          minIntegerDigits="1"/>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-control col-md-7 col-xs-12 active">
                                        <fmt:formatNumber value="${orderForm.processingFee}" type="number"
                                                          maxFractionDigits="2" minFractionDigits="2"
                                                          minIntegerDigits="1"/>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Non-Secure Document
                                    Fee:</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-control col-md-7 col-xs-12 active">
                                        <fmt:formatNumber value="${orderForm.nonSecureDocumentFee}" type="number"
                                                          maxFractionDigits="2" minFractionDigits="2"
                                                          minIntegerDigits="1"/>
                                    </div>
                                </div>
											...
											<span class="selection">
												<span class="select2-selection select2-selection--multiple"
													...
													<ul class="select2-selection__rendered">
														<c:forEach items="${orderForm.orderFormExams}"
                                                                   var="orderFormExam">
															<li class="select2-selection__choice"
                                                                title="${orderFormExam.exam.name}">
										...
										<span class="select2 select2-container select2-container--default select2-container--below select2-container--focus"
											...
											<span class="selection">
												<span class="select2-selection select2-selection--multiple"
                                                      ...
                                                      tabindex="-1">
													<ul class="select2-selection__rendered">
														<c:forEach items="${orderForm.orderFormDocuments}"
                                                                   var="orderFormDocument">
															<li class="select2-selection__choice"
                                                                title="${orderFormDocument.document.name}">

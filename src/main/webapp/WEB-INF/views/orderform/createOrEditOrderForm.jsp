                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form:form method="POST" modelAttribute="orderForm" class="form-horizontal form-label-left"
                            ...
                            <div class="item form-group has-feedback">
                                ...
                                <div class="input-group col-md-6 col-sm-6 col-xs-6">
                                    ...
                                    <form:input type="text" path="name" id="name"
                                                ...
                                                placeholder="Order Form Name" required="required"/>
                                </div>
                            ...
                            <div class="item form-group has-feedback">
                                <label for="startDate" class="control-label col-md-3 col-sm-3 col-xs-3 left">Start
                                    Date</label>
                                <div class="input-group col-md-6 col-sm-6 col-xs-6">
                                    ...
                                    <form:input type="text"
                                                ...
                                                path="startDate" id="orderFormStartDate" value="${fStartDate}"
                                                class="date-picker form-control col-md-7 col-xs-12 active"
                                                name="startDate" placeholder="Order Form Start Date"
                                                required="required"/>
                                </div>
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                <!-- <div class="help-block with-errors">Hey look, this one has feedback icons!</div> -->
                            ...
                            <div class="item form-group has-feedback">
                                <label for="endDate" class="control-label col-md-3 col-sm-3 col-xs-3 left">End
                                    Date</label>
                                <div class="input-group col-md-6 col-sm-6 col-xs-6">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                    ...
                                    <form:input type="text"
                                                pattern="(0[1-9]|1[012])[- /.](0[1-9]|[12][0-9]|3[01])[- /.](19|20)\d\d"
                                                path="endDate" id="orderFormEndDate" value="${fEndDate}"
                                                class="date-picker form-control col-md-7 col-xs-12 active"
                                                name="endDate" placeholder="Order Form End Date" required="required"/>
                                </div>
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                <!-- <div class="help-block with-errors">Hey look, this one has feedback icons!</div> -->
                            </div>
                            ...
                            <form:input type="hidden" value="0.00" path="inDistrictScanFee" id="inDistrictScanFee"
                                        name="inDistrictScanFee"/>
                            <form:input type="hidden" value="0.00" path="processingFee" id="processingFee"
                                        name="processingFee"/>
                            <form:input type="hidden" value="0.00" path="nonSecureDocumentFee" id="nonSecureDocumentFee"
                                        name="nonSecureDocumentFee"/>
                            ...
                            <div class="item form-group has-feedback">
                                <label for="orderFormExams"
                                       class="control-label col-md-3 col-sm-3 col-xs-3 left">Exams</label>
                                <div class="input-group col-md-6 col-sm-6 col-xs-6">
                                    <span class="input-group-addon"><i class="fa fa-files-o"></i></span>
                                    <c:choose>
                                        <c:when test="${edit}">
                                            <form:select path="orderFormExams" multiple="true"
                                                ...
                                                <c:forEach items="${selectedExams}" var="selectedExam">
                                                    <c:choose>
                                                        <c:when test="${selectedExam.selected eq 'true'}">
                                                            <form:option selected="true" value="${selectedExam.exam.id}"
                                                                         label="${selectedExam.exam.name}"/>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <c:if test="${selectedExam.exam.visible eq true}">
                                                                <form:option value="${selectedExam.exam.id}"
                                                                             label="${selectedExam.exam.name}"/>
                                                            </c:if>
                                                        </c:otherwise>
                                                    </c:choose>
                            ...
                            <div class="item form-group has-feedback">
                                ...
                                <div class="input-group col-md-6 col-sm-6 col-xs-6">
                                    ...
                                    <c:choose>
                                        <c:when test="${edit}">
                                            <form:select path="orderFormDocuments" multiple="true"
                                                         class="select2_multiple form-control" required="required">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${selectedDocument.selected eq 'true'}">
                                                            <form:option selected="true"
                                                                         value="${selectedDocument.document.id}"
                                                                         label="${selectedDocument.document.name}"/>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <c:if test="${selectedDocument.document.visible eq true}">
                                                                <form:option value="${selectedDocument.document.id}"
                                                                             label="${selectedDocument.document.name}"/>
                                                            </c:if>
                                                        </c:otherwise>
                                                    </c:choose>
                                    ...
                                    <c:choose>
                                        <c:when test="${edit}">
                                            <input type="submit" value="Update" class="btn btn-success"/> <a
                                                href="<c:url value='/admin/orderForms' />" class="btn btn-primary">Cancel</a>
                                        </c:when>
                                        <c:otherwise>

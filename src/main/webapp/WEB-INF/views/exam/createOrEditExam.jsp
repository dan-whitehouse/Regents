                    ...
                    <div class="x_content">
                        ...
                        <form:form method="POST" modelAttribute="exam" class="form-horizontal form-label-left"
                            ...
                            <div class="item form-group has-feedback">
                                <label for="name" class="control-label col-md-3 col-sm-3 col-xs-3 left">Exam
                                    Name</label>
                                <div class="input-group col-md-6 col-sm-6 col-xs-6">
                                    <span class="input-group-addon"><i class="fa fa-file-o"></i></span>
                                    <form:input type="text" path="name" id="name"
                                                class="form-control col-md-7 col-xs-12 active" name="name"
                                                placeholder="Exam Name" required="required"/>
                                </div>
                            ...
                            <div class="item form-group has-feedback">
                                <label for="code" class="control-label col-md-3 col-sm-3 col-xs-3 left">Exam
                                    Code</label>
                                <div class="input-group col-md-6 col-sm-6 col-xs-6">
                                    <span class="input-group-addon"><i class="fa fa-file-o"></i></span>
                                    <form:input type="text" path="code" id="code"
                                                class="form-control col-md-7 col-xs-12 active" name="code"
                                                placeholder="Exam Code" required="required"/>
                                </div>
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                <!-- <div class="help-block with-errors">Hey look, this one has feedback icons!</div> -->
                            </div>
                                    ...
                                    <c:choose>
                                        <c:when test="${edit}">
                                            <input type="submit" value="Update" class="btn btn-success"/> <a
                                                href="<c:url value='/admin/exams' />" class="btn btn-primary">Cancel</a>
                                        </c:when>
                                        <c:otherwise>

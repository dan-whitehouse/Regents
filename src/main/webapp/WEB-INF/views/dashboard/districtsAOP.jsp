                    ...
                    <div class="x_content">
                        ...
                        <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <c:forEach var="districtOrder" items="${districtsOrder}">
                                <tr>
                                    <td>
                                        <a href="<c:url value='/admin/districts/${districtOrder.district.uuid}' />">${districtOrder.district.name}</a>
                                    </td>
                        ...
                        <sec:authorize access="hasRole('ADMIN')">
                            <c:forEach items="${districtsOrder}" var="districtOrder">
                                <div class="modal fade modal-sm-${districtOrder.district.uuid}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-sm">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="<c:url value='/admin/districts/${districtOrder.district.uuid}/delete' />"

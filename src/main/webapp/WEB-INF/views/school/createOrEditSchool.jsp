                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form:form method="POST" modelAttribute="school" class="form-horizontal form-label-left"
                            ...
                            <div class="item form-group has-feedback">
                                <label for="district"
                                       class="control-label col-md-3 col-sm-3 col-xs-3 left">District</label>
                                <div class="input-group col-md-6 col-sm-6 col-xs-6">
                                    <span class="input-group-addon"><i class="fa fa-university"></i></span>
                                    <form:select path="district" items="${districts}" itemValue="id" itemLabel="name"
                                                 cssClass="form-control col-md-12 col-xs-12 active"
                                                 required="required"/>
                                </div>
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                            </div>

                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form:form method="POST" modelAttribute="district" class="form-horizontal form-label-left"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="input-group col-md-6 col-sm-6 col-xs-6">
                                    ...
                                    <form:input type="text" path="bedsCode" id="bedsCode"
                                                ...
                                                placeholder="BEDS Code" readonly="true"/>
                                </div>
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                            </div>
                            ...
                            <div class="item form-group">
                                <label for="schools"
                                       class="control-label col-md-3 col-sm-3 col-xs-3 left">Schools</label>
                                <div class="input-group col-md-6 col-sm-6 col-xs-6">
                                    ...
                                    <select multiple="true" class="select2_multiple form-control" readonly="true">
                                        <c:forEach items="${district.schools}" var="school">
                                            <option selected="true" value="${school.id}"
                                                    disabled>${school.name}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>

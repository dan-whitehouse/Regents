...
<head>
    ...
    <link href="<c:url value='/resources/vendors/datatables.net-buttons-bs/css/buttons.bootstrap.min.css' />"
          rel="stylesheet" type="text/css">
    <link href="<c:url value='/resources/vendors/datatables.net-fixedheader-bs/css/fixedHeader.bootstrap.min.css' />"
          rel="stylesheet" type="text/css">
    <link href="<c:url value='/resources/vendors/datatables.net-responsive-bs/css/responsive.bootstrap.min.css' />"
          rel="stylesheet" type="text/css">
    <link href="<c:url value='/resources/vendors/datatables.net-scroller-bs/css/scroller.bootstrap.min.css' />"
          rel="stylesheet" type="text/css">
        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="${home}" class="site_title"><i><img
                            src="<c:url value='/resources/images/NericLogo_2c_icon.png' />" alt=""/></i><span>Regents Order Form</span></a>
                </div>
                    ...
                    <div class="menu_section">
                        <ul class="nav side-menu">
                            <sec:authorize access="hasAnyRole('USER', 'ADMIN')">
                                ...
                                <li><a href="${order}"><i class="fa fa-edit"></i> Order Form</a></li>
                                <li><a href="${optout}"><i class="fa fa-sign-out"></i> Not Administering</a></li>
                                <li><a href="${orders}"><i class="fa fa-truck"></i>My Orders</a></li>
                                <li><a href="${optouts}"><i class="fa fa-exclamation-triangle"></i> Past
                                    Non-Administrations</a></li>
                            </sec:authorize>
                            ...
                            <sec:authorize access="hasRole('ADMIN')">
                                <li>
                                    ...
                                    <ul class="nav child_menu">
                                        ...
                                        <li><a><i class="fa fa-sitemap"></i> Users <span
                                        ...
                                        <li><a><i class="fa fa-check-square"></i> Order Forms <span
                                                class="fa fa-chevron-down"></span></a>
                                            <ul class="nav child_menu">
                                        ...
                                        <li><a href="${adminOptouts}"><i class="fa fa-exclamation-triangle"></i> Not
                                            Administering</a></li>
                                        <li><a href="${documents}"><i class="fa fa-file-text"></i> Documents </a></li>
                                        <li><a href="${exams}"><i class="fa fa-list"></i> Exams </a></li>
                                        <li><a href="${printOptions}"><i class="fa fa-print"></i> Print Options </a>
                                        </li>
                                        <li><a href="${scanOptions}"><i class="fa fa-clipboard"></i> Scan Options </a>
                                        </li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            ...
                            <ul class="dropdown-menu dropdown-usermenu pull-right">
                                <sec:authorize access="hasAnyRole('USER', 'ADMIN')">
                                    <li><a href="<c:url value="/profile" />"><i class="fa fa-user pull-right"></i>
                                        Profile</a></li>
                                    <li><a href="<c:url value="/logout" />"><i class="fa fa-sign-out pull-right"></i>
                                        Log Out</a></li>
                                    <li><a href="<c:url value="/changePassword" />"><i
                                            class="fa fa-asterisk pull-right"></i> Change Password</a></li>
                                </sec:authorize>
                            </ul>
                        </li>
                    </ul>

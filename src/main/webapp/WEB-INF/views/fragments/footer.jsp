...
<footer>
    ...
    <div class="pull-right">
        <p class="right_orgInfo" style="font-size:13px;">Northeastern Regional Information Center<br/>
            ...
            <span class="right_version" style="font-size:10px;">NERIC Regents Order Form v1.0.10</span>
        </p>
    </div>
    <div class="clearfix"></div>
</footer>
    ...
    function validateStep2() {
        ...
        for (i = 0; i <= count - 1; i++) {
            if (document.getElementById('selectedExams' + i + '.selected1').checked) {
                ...
                // alert("examAmount: " + examAmount + " answerSheetAmount: " + answerSheetAmount + " studentsPerCSV: " + studentsPerCSV)
        ...
        // alert("uncheckedCount: " + uncheckedCount + " zeroCount: " + zeroCount + " validCount: " + validCount + " checkedCount: " + checkedCount);

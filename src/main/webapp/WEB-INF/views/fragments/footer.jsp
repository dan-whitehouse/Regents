...
<footer>
    ...
    <div class="pull-right">
        <p class="right_orgInfo" style="font-size:13px;">Northeastern Regional Information Center<br/>
            <span class="right_orgInfo"
                  style="font-size:10px;">900 Watervliet-Shaker Road | Albany, New York 12205</span>
            <span class="right_version" style="font-size:10px;">NERIC Regents Order Form v1.0.8</span>
        </p>
    </div>
    <div class="clearfix"></div>
</footer>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#deactivate-step-2').on('click', function () {
        ...
        $('#deactivate-step-3').on('click', function () {
            $('ul.setup-panel li:eq(2)').removeClass('active');
            $('ul.setup-panel li a[href="#step-2"]').trigger('click');
            //$(this).remove();
        })

        $('#activate-step-4').on('click', function () {
            $('ul.setup-panel li:eq(3)').removeClass('disabled');
            $('ul.setup-panel li a[href="#step-4"]').trigger('click');
            //$(this).remove();
        });

        $('#deactivate-step-4').on('click', function () {
        ...
        $('#deactivate-step-5').on('click', function () {
            $('ul.setup-panel li:eq(4)').removeClass('active');
            $('ul.setup-panel li a[href="#step-4"]').trigger('click');
        });

        $('#activate-step-6').on('click', function () {
            if (!validateStep5()) {
                $('#xForm2').validator('update');
                $('#xForm2').validator('validate');
            } else {
        ...
        $('#deactivate-step-6').on('click', function () {
            $('ul.setup-panel li:eq(5)').removeClass('active');
            $('ul.setup-panel li a[href="#step-5"]').trigger('click');
            //$(this).remove();
        });

        $('#activate-step-7').on('click', function () {
            if (!validateStep6()) {
                $('#xForm2').validator('update');
                $('#xForm2').validator('validate');
            } else {
        ...
        $('#deactivate-step-7').on('click', function () {

            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                                    ...
                                    <sec:authorize access="hasRole('ADMIN')">
                                        <td width="150px">
                                            <a type="button" class="btn btn-danger custom-width" data-toggle="modal"
                                               data-target=".modal-sm-${optout.uuid}"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </sec:authorize>
                                </tr>
                            </c:forEach>
                        ...
                        <sec:authorize access="hasRole('ADMIN')">
                            <c:forEach items="${optouts}" var="optout">
                                <div class="modal fade modal-sm-${optout.uuid}" tabindex="-1" role="dialog"
                                     aria-hidden="true">
                                    <div class="modal-dialog modal-sm">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="<c:url value='/notadministration/${optout.uuid}/delete' />"
